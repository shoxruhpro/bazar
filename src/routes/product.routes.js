    ...
    .get(async (req, res) => {
        ...
        try {
            const product = await db.oneOrNone(
                'SELECT product_id, product_name, info, product_description, product_address, brand, price, old_price, p.phone_number, p.email, variants, photos, full_name, p.user_id, u.photo, u.last_visit ' +
